        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          ...
          {activeTab === 'orders' && (
            <div className="space-y-3">
              {orders.length ? (
                orders.map(order => (
                  <div key={order._id.toString()} className="bg-gray-50 p-4 rounded-xl">
                ...
                customer.smsHistory.map((sms, idx) => (
                  <div key={idx} className="bg-gray-50 rounded-xl p-4">
                    ...
                    <div className="flex items-center gap-3 mt-2 flex-wrap">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full ${sms.type === 'bulk' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'
                        }`}>
                        {sms.type}
                      </span>
                      <span className={`text-xs px-2 py-0.5 rounded-full ${sms.status === 'sent' ? 'bg-green-100 text-green-700' :
