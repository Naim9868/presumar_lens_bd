...
import { X, MapPin, Truck, CreditCard, ShoppingBag, AlertCircle, CheckCircle, ChevronRight } from 'lucide-react';
...
export function OrderFormModal({ isOpen, onClose, product, cartItems = [] }: OrderFormModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formDataObj.append('shippingName', formData.name);
    formDataObj.append('shippingPhone', formData.phone);
    formDataObj.append('shippingAddress', formData.address);
    formDataObj.append('shippingArea', formData.area);
    formDataObj.append('shippingCity', formData.city);
    formDataObj.append('deliveryType', deliveryType);
