...
const SingleItem = ({ item, removeItemFromCart }: SingleItemProps) => {
  ...
  const variantInfo = item.variant?.attributes?.length 
  ...
  return (
    <div className="flex items-center justify-between gap-5">
      ...
      <button
        ...
        className="flex items-center justify-center rounded-lg max-w-[38px] w-full h-9.5 bg-gray-50 border border-gray-200 text-dark ease-out duration-200 hover:bg-red-50 hover:border-red-200 hover:text-red-500 flex-shrink-0"
      >
        <svg
